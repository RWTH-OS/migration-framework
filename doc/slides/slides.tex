...
\begin{frame}{Procedure}
	\begin{figure}
		\begin{tikzpicture}[scheduler/.style={
			...
			% Path
			\draw [thick,->] ($(scheduler.north east)!(communicator.105)!(scheduler.south east)$) -- (communicator.105);
			\draw [thick,->] (communicator.255) -- ($(scheduler.north east)!(communicator.255)!(scheduler.south east)$);

			\draw [thick,->] ($(communicator.north east)!(parser.105)!(communicator.south east)$) -- (parser.105);
			\draw [thick,->] (parser.255) -- ($(communicator.north east)!(parser.255)!(communicator.south east)$);
