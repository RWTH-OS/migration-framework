...
\begin{frame}{Procedure}
	\begin{figure}
		\begin{tikzpicture}[scheduler/.style={
			...
			% Path
			\draw [thick,->] ($(scheduler.north east)!(taskhandler.west)!(scheduler.south east)$) -- ($(communicator.north west)!(taskhandler.west)!(communicator.south west)$);
			\draw [thick,->] ($(communicator.north west)!(hypervisor.west)!(communicator.south west)$) -- ($(scheduler.north east)!(hypervisor.west)!(scheduler.south east)$);

			\draw [thick,->] ($(communicator.north east)!(taskhandler.west)!(communicator.south east)$) -- ($(parser.north west)!(taskhandler.west)!(parser.south west)$);
			\draw [thick,->] ($(parser.north west)!(hypervisor.west)!(parser.south west)$) -- ($(communicator.north east)!(hypervisor.west)!(communicator.south east)$);

			\draw [thick,->] ($(parser.north east)!(taskhandler.west)!(parser.south east)$) -- (taskhandler.west);
			...
			\draw [thick,->] ($(taskhandler.south west)!(taskR.north)!(taskhandler.south east)$) -- (taskR.north);
			...
			\draw [thick,->] (taskR.west) -- ($(parser.north east)!(taskR.west)!(parser.south east)$);
